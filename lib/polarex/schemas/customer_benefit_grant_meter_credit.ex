defmodule Polarex.CustomerBenefitGrantMeterCredit do
  @moduledoc """
  Provides struct and type for a CustomerBenefitGrantMeterCredit
  """

  @type t :: %__MODULE__{
          benefit: Polarex.BenefitMeterCreditSubscriber.t(),
          benefit_id: String.t(),
          ...
          properties: Polarex.BenefitGrantMeterCreditProperties.t(),
